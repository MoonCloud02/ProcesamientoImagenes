...
| Aspecto | MSE | PSNR |
|---------|-----|------|
| **Unidades** | Intensidad al cuadrado | Decibeles (dB) |
| **Escala** | Lineal | Logarítmica |
| **Interpretación** | Difícil (valores grandes) | Intuitiva (más alto = mejor) |
| **Rango típico** | 0 a ∞ | 0 a ∞ dB (típicamente 20-50 dB) |
| **Normalización** | No normalizado | Normalizado por $\text{MAX}_I^2$ |
| **Relación** | - | Se calcula a partir del MSE |
...
| MSE | PSNR (dB) | Interpretación |
|-----|-----------|----------------|
| 1 | 48.13 | Excelente |
| 10 | 38.13 | Muy buena |
| 100 | 28.13 | Límite aceptable |
| 1000 | 18.13 | Pobre |
...
SSIM = 0.75 → ⚠️ ALERTA: Estructura comprometida
...
| Aspecto | MSE/PSNR | SSIM | Relevancia Médica |
|---------|----------|------|-------------------|
| Ruido uniforme | Detecta bien | Detecta bien | Media |
| Pérdida de bordes | Detecta mal | Detecta bien | **ALTA** |
| Cambios de contraste | Detecta mal | Detecta bien | **ALTA** |
| Distorsión estructural | Detecta mal | Detecta bien | **CRÍTICA** |
| Artefactos localizados | Detecta mal | Detecta bien | **ALTA** |
| Difuminación | Detecta mal | Detecta bien | **ALTA** |
...
| Comparación | Diferencia MSE | Diferencia PSNR | Percepción |
|-------------|----------------|-----------------|------------|
| A (MSE=1) vs B (MSE=2) | 1 | 3 dB | Apenas notable |
| C (MSE=100) vs D (MSE=101) | 1 | 0.04 dB | Imperceptible |
| E (MSE=1) vs F (MSE=10) | 9 | 10 dB | Muy notable |
| G (MSE=100) vs H (MSE=1000) | 900 | 10 dB | Muy notable (similar a E vs F) |
...
| Versión | MSE | Cambio MSE | PSNR (dB) | Cambio PSNR | Interpretación MSE | Interpretación PSNR |
|---------|-----|------------|-----------|-------------|-------------------|---------------------|
| V1 | 1000 | - | 18.13 | - | Inicial | Muy pobre |
| V2 | 500 | -500 (-50%) | 21.14 | +3.01 | Mejora grande | Mejora constante |
| V3 | 250 | -250 (-50%) | 24.15 | +3.01 | Mejora media | Mejora constante |
| V4 | 125 | -125 (-50%) | 27.16 | +3.01 | Mejora pequeña | Mejora constante |
| V5 | 62.5 | -62.5 (-50%) | 30.17 | +3.01 | Mejora muy pequeña | Mejora constante |
...
5. ⚠️ **No elimina** las limitaciones fundamentales de no capturar aspectos estructurales
...
|---------|-------|----------------|
| MSE | 14.5 | Error promedio al cuadrado moderado |
| PSNR | 36.52 dB | Calidad buena (> 30 dB) |
| SSIM | 0.9976 | Similitud estructural excelente |
...
|------------|-------|----------------|
| **Luminancia** $l(r,n)$ | 1.0000 | Brillo promedio idéntico |
| **Contraste** $c(r,n)$ | 0.9986 | Variabilidad muy similar |
...
| Componente | Valor | Contribución al resultado |
|------------|-------|---------------------------|
| Luminancia $l$ | 0.98 | Reduce SSIM en 2% |
| Contraste $c$ | 0.95 | Reduce SSIM en 5% |
| Estructura $s$ | 0.97 | Reduce SSIM en 3% |
| **Total** | **0.9031** | **Reducción acumulada ~10%** |
