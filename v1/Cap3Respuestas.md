...
5. **Diferencia entre RAW, TIFF, JPEG, PNG y GIF (Hacer una tabla).**
   ...
   | Formato | Descripción | Compresión | Pérdidas | Usos Principales | Ventajas | Desventajas |
   |----------|-------------|------------|----------|------------------|----------|-------------|
   | RAW     | Contiene información directa de sensores, requiere reconstrucción | Con o sin compresión sin pérdidas | Sin pérdidas visibles | Fotografía profesional | Alta calidad, editable | Archivos grandes, requiere software especial |
   | TIFF    | Formato flexible para imágenes de alta calidad | Varios tipos (JPEG, LZW, ZIP o ninguna) | Sin pérdidas (si no se comprime) | Diseño gráfico, publicación | Alta calidad, capas, flexible | Archivos muy grandes |
   | JPEG    | Compresión alta para fotografías | Con pérdidas | Sí, artefactos | Web, fotografías | Pequeño tamaño, compatible | Pierde calidad, no transparencias |
   | PNG     | Formato para web con transparencia | Sin pérdidas | No | Web, gráficos con transparencias | Transparencia, calidad | Archivos más grandes que JPEG |
   | GIF     | Limitado a 256 colores, soporta animaciones | Sin pérdidas | No (para colores limitados) | Animaciones, gráficos simples | Animaciones, transparencias | Solo 256 colores, archivos grandes si muchos colores |
